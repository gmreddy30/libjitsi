package org.jitsi.communication;
...
/**
 * Both voice sender and receiver 
 * @author Jason
 *
 */
public class VoiceSenderReceiver {
	 ...
	 */
	public VoiceSenderReceiver(String localPortBase, String remoteHost, String remotePortBase) throws Exception {
	...
	public String start() throws Exception {
		...
		if (localPortBase == -1) {
			...
			System.out.println("localRTPPort :" +localRTPPort + " :::");
			System.out.println("localRTCPPort : " +localRTCPPort +" :::");
